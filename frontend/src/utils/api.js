...
/**
 * Transform a curriculum atom for a given cognitive profile.
 *
 * @param {string} atomId
 * @param {string} text
 * @param {string} profile - 'adhd' | 'dyslexia' | 'asd'
...
/**
 * Transform multiple atoms for a single profile in one call.
 *
