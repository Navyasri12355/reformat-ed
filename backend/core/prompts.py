"""
NeuraCore — Cognitive Profile Prompt Templates
===============================================
Three carefully engineered system prompts — one per neurodivergent profile.
This is the core IP of the project. Do not change these after Phase 3 begins.
...
def build_prompt(profile: ProfileType, atom_text: str) -> list[dict]:
    """
    Return the messages list ready for the OpenAI / Anthropic chat API.

    Args:
        profile:   One of "adhd", "dyslexia", "asd"
        atom_text: Raw curriculum text from the parser
